      ...
      <form nz-form nzLayout="vertical">
          <nz-form-item>
            <nz-form-control>
              ...
              <input class="h-[50px] border-normal dark:border-white/10 px-[20px] placeholder-shown:text-light-extra dark:placeholder-shown:text-white/60 rounded-[5px] dark:bg-white/10" type="email" nz-input placeholder="Email">
            </nz-form-control>
          </nz-form-item>
          <nz-form-item>
            <nz-form-control>
              ...
              <input class="h-[50px] border-normal dark:border-white/10 px-[20px] placeholder-shown:text-light-extra dark:placeholder-shown:text-white/60 rounded-[5px] dark:bg-white/10" type="text" nz-input placeholder="Subject">
            </nz-form-control>
          </nz-form-item>
          <nz-form-item>
            <nz-form-control>
